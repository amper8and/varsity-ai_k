...
export const IMAGES = {
  ...
  uber: 'https://images.unsplash.com/photo-1566241440091-ec10de8db2e1?w=400&h=300&fit=crop',
  slot: 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=400&h=300&fit=crop',
  ...
  // shopping → now used as deals hero, African students studying
  shopping: 'https://images.unsplash.com/photo-1529390079861-591f7f9383f3?w=800&h=400&fit=crop',
...
export const PARTNERS = {
  chickenRepublic: { name: 'Chicken Republic', color: 'from-red-500 to-red-600', textColor: 'text-white' },
  mtn: { name: 'MTN', color: 'from-mtn-400 to-mtn-500', textColor: 'text-white' },
  jumia: { name: 'Jumia', color: 'from-orange-400 to-orange-500', textColor: 'text-white' },
  bolt: { name: 'Bolt', color: 'from-green-400 to-green-500', textColor: 'text-white' },
  uber: { name: 'Uber', color: 'from-gray-700 to-black', textColor: 'text-white' },
  slot: { name: 'Slot', color: 'from-blue-400 to-blue-500', textColor: 'text-white' },
}
